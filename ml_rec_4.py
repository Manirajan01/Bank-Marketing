...
Original file is located at
    https://colab.research.google.com/drive/1l5nEgv6qxc8x0jS8NEcYCpLtakBAAMI_
...
"""Here, the training-set accuracy score is 0.9086 while the test-set accuracy to  


be 0.9035. These two values are quite comparable. 
"""
